...
```
```{r adding-locations-to-national-parks}
# park_locations <- park_locations %>% clean_names()
# colnames(park_locations)[colnames(park_locations)=="place_name"] <- "park_name"
# 
# plot_data <- park_revenue_data %>% 
#   regex_join(park_locations, ., ignore_case = TRUE)
```
